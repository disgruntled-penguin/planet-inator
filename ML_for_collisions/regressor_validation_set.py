...
if __name__ == "__main__":
    ...
    filename = top_dir + 'ML_data/regression_train_data.pkl'
    f = open(filename, "rb")
    ...
    # load model
    mlp_model = torch.load(top_dir + 'ML_models/final_cols_regression.torch', map_location=torch.device('cpu'))
    
    # make predictions
    eval_preds = mlp_model.make_pred(eval_inputs)

    # save results
    with open(top_dir + 'ML_data/ML_regressor_validation_preds.pkl', 'wb') as f:
